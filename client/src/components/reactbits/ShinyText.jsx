// Adapted from ReactBits (reactbits.dev) — ShinyText
// Sweeping light-sheen animation over text.
// Uses framer-motion only — fully self-contained (no CSS file).
...
export default function ShinyText({
  ...
  // p=0 → shine off right (150%), p=100 → shine off left (-50%)
