    ...
    <Page title="Editor — Fine Art Print">
      <Container className="px-0">
        ...
        <div className="px-4 pt-4 pb-2">
          <h1 className="text-2xl font-extrabold tracking-tight text-slate-900">Fine Art Print</h1>
          <p className="mt-0.5 text-sm text-slate-500">Museum-Quality Prints On Premium Paper.</p>
        </div>
